...
docker build --file 12.22/Dockerfile -t cimg/node:12.22.5  -t cimg/node:12.22  -t cimg/node:lts .
docker build --file 12.22/browsers/Dockerfile -t cimg/node:12.22.5-browsers  -t cimg/node:12.22-browsers  -t cimg/node:lts-browsers .
