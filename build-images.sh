...
docker build --file 14.14/browsers/Dockerfile -t cimg/node:14.14.0-browsers  -t cimg/node:14.14-browsers .
docker build --file 14.15/browsers/Dockerfile -t cimg/node:14.15.0-browsers  -t cimg/node:14.15-browsers .
docker build --file 15.0/browsers/Dockerfile -t cimg/node:15.0.1-browsers  -t cimg/node:15.0-browsers .
