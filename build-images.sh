...
docker build --file 17.3/Dockerfile -t cimg/node:17.3.1  -t cimg/node:17.3 .
docker build --file 17.3/browsers/Dockerfile -t cimg/node:17.3.1-browsers  -t cimg/node:17.3-browsers .
